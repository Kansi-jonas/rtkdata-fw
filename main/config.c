...
const config_item_t CONFIG_ITEMS[] = {
        ...
        // NTRIP Server 1
        {
                .key = KEY_CONFIG_NTRIP_SERVER_ACTIVE_1,
                .type = CONFIG_ITEM_TYPE_BOOL,
                .def.bool1 = false
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_COLOR_1,
                .type = CONFIG_ITEM_TYPE_COLOR,
                .def.color.rgba = 0x00000055u
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_HOST_1,
                .type = CONFIG_ITEM_TYPE_STRING,
                .def.str = ""
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_PORT_1,
                .type = CONFIG_ITEM_TYPE_UINT16,
                .def.uint16 = 2101
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_MOUNTPOINT_1,
                .type = CONFIG_ITEM_TYPE_STRING,
                .def.str = ""
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_USERNAME_1,
                .type = CONFIG_ITEM_TYPE_STRING,
                .def.str = ""
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_PASSWORD_1,
                .type = CONFIG_ITEM_TYPE_STRING,
                .secret = true,
                .def.str = ""
        },
        ...
        // NTRIP Server 2
        {
                .key = KEY_CONFIG_NTRIP_SERVER_ACTIVE_2,
                .type = CONFIG_ITEM_TYPE_BOOL,
                .def.bool1 = false
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_COLOR_2,
                .type = CONFIG_ITEM_TYPE_COLOR,
                .def.color.rgba = 0x00000055u
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_HOST_2,
                .type = CONFIG_ITEM_TYPE_STRING,
                .def.str = ""
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_PORT_2,
                .type = CONFIG_ITEM_TYPE_UINT16,
                .def.uint16 = 2101
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_MOUNTPOINT_2,
                .type = CONFIG_ITEM_TYPE_STRING,
                .def.str = ""
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_USERNAME_2,
                .type = CONFIG_ITEM_TYPE_STRING,
                .def.str = ""
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_PASSWORD_2,
                .type = CONFIG_ITEM_TYPE_STRING,
                .secret = true,
                .def.str = ""
        },
        ...
        // NTRIP Server 3
        {
                .key = KEY_CONFIG_NTRIP_SERVER_ACTIVE_3,
                .type = CONFIG_ITEM_TYPE_BOOL,
                .def.bool1 = false
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_COLOR_3,
                .type = CONFIG_ITEM_TYPE_COLOR,
                .def.color.rgba = 0x00000055u
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_HOST_3,
                .type = CONFIG_ITEM_TYPE_STRING,
                .def.str = ""
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_PORT_3,
                .type = CONFIG_ITEM_TYPE_UINT16,
                .def.uint16 = 2101
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_MOUNTPOINT_3,
                .type = CONFIG_ITEM_TYPE_STRING,
                .def.str = ""
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_USERNAME_3,
                .type = CONFIG_ITEM_TYPE_STRING,
                .def.str = ""
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_PASSWORD_3,
                .type = CONFIG_ITEM_TYPE_STRING,
                .secret = true,
                .def.str = ""
        },
        ...
        // NTRIP Server 4
        {
                .key = KEY_CONFIG_NTRIP_SERVER_ACTIVE_4,
                .type = CONFIG_ITEM_TYPE_BOOL,
                .def.bool1 = false
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_COLOR_4,
                .type = CONFIG_ITEM_TYPE_COLOR,
                .def.color.rgba = 0x00000055u
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_HOST_4,
                .type = CONFIG_ITEM_TYPE_STRING,
                .def.str = ""
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_PORT_4,
                .type = CONFIG_ITEM_TYPE_UINT16,
                .def.uint16 = 2101
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_MOUNTPOINT_4,
                .type = CONFIG_ITEM_TYPE_STRING,
                .def.str = ""
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_USERNAME_4,
                .type = CONFIG_ITEM_TYPE_STRING,
                .def.str = ""
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_PASSWORD_4,
                .type = CONFIG_ITEM_TYPE_STRING,
                .secret = true,
                .def.str = ""
        },
        ...
        // NTRIP Server 5
        {
                .key = KEY_CONFIG_NTRIP_SERVER_ACTIVE_5,
                .type = CONFIG_ITEM_TYPE_BOOL,
                .def.bool1 = false
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_COLOR_5,
                .type = CONFIG_ITEM_TYPE_COLOR,
                .def.color.rgba = 0x00000055u
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_HOST_5,
                .type = CONFIG_ITEM_TYPE_STRING,
                .def.str = ""
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_PORT_5,
                .type = CONFIG_ITEM_TYPE_UINT16,
                .def.uint16 = 2101
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_MOUNTPOINT_5,
                .type = CONFIG_ITEM_TYPE_STRING,
                .def.str = ""
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_USERNAME_5,
                .type = CONFIG_ITEM_TYPE_STRING,
                .def.str = ""
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_PASSWORD_5,
                .type = CONFIG_ITEM_TYPE_STRING,
                .secret = true,
                .def.str = ""
        },
        ...
        // NTRIP Server 6
        {
                .key = KEY_CONFIG_NTRIP_SERVER_ACTIVE_6,
                .type = CONFIG_ITEM_TYPE_BOOL,
                .def.bool1 = false
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_COLOR_6,
                .type = CONFIG_ITEM_TYPE_COLOR,
                .def.color.rgba = 0x00000055u
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_HOST_6,
                .type = CONFIG_ITEM_TYPE_STRING,
                .def.str = ""
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_PORT_6,
                .type = CONFIG_ITEM_TYPE_UINT16,
                .def.uint16 = 2101
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_MOUNTPOINT_6,
                .type = CONFIG_ITEM_TYPE_STRING,
                .def.str = ""
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_USERNAME_6,
                .type = CONFIG_ITEM_TYPE_STRING,
                .def.str = ""
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_PASSWORD_6,
                .type = CONFIG_ITEM_TYPE_STRING,
                .secret = true,
                .def.str = ""
        },
        ...
        // NTRIP Server 7
        {
                .key = KEY_CONFIG_NTRIP_SERVER_ACTIVE_7,
                .type = CONFIG_ITEM_TYPE_BOOL,
                .def.bool1 = false
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_COLOR_7,
                .type = CONFIG_ITEM_TYPE_COLOR,
                .def.color.rgba = 0x00000055u
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_HOST_7,
                .type = CONFIG_ITEM_TYPE_STRING,
                .def.str = ""
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_PORT_7,
                .type = CONFIG_ITEM_TYPE_UINT16,
                .def.uint16 = 2101
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_MOUNTPOINT_7,
                .type = CONFIG_ITEM_TYPE_STRING,
                .def.str = ""
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_USERNAME_7,
                .type = CONFIG_ITEM_TYPE_STRING,
                .def.str = ""
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_PASSWORD_7,
                .type = CONFIG_ITEM_TYPE_STRING,
                .secret = true,
                .def.str = ""
        },
        ...
        // NTRIP Server 8
        {
                .key = KEY_CONFIG_NTRIP_SERVER_ACTIVE_8,
                .type = CONFIG_ITEM_TYPE_BOOL,
                .def.bool1 = false
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_COLOR_8,
                .type = CONFIG_ITEM_TYPE_COLOR,
                .def.color.rgba = 0x00000055u
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_HOST_8,
                .type = CONFIG_ITEM_TYPE_STRING,
                .def.str = ""
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_PORT_8,
                .type = CONFIG_ITEM_TYPE_UINT16,
                .def.uint16 = 2101
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_MOUNTPOINT_8,
                .type = CONFIG_ITEM_TYPE_STRING,
                .def.str = ""
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_USERNAME_8,
                .type = CONFIG_ITEM_TYPE_STRING,
                .def.str = ""
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_PASSWORD_8,
                .type = CONFIG_ITEM_TYPE_STRING,
                .secret = true,
                .def.str = ""
        },
        ...
        // NTRIP Server 9
        {
                .key = KEY_CONFIG_NTRIP_SERVER_ACTIVE_9,
                .type = CONFIG_ITEM_TYPE_BOOL,
                .def.bool1 = false
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_COLOR_9,
                .type = CONFIG_ITEM_TYPE_COLOR,
                .def.color.rgba = 0x00000055u
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_HOST_9,
                .type = CONFIG_ITEM_TYPE_STRING,
                .def.str = ""
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_PORT_9,
                .type = CONFIG_ITEM_TYPE_UINT16,
                .def.uint16 = 2101
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_MOUNTPOINT_9,
                .type = CONFIG_ITEM_TYPE_STRING,
                .def.str = ""
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_USERNAME_9,
                .type = CONFIG_ITEM_TYPE_STRING,
                .def.str = ""
        }, {
                .key = KEY_CONFIG_NTRIP_SERVER_PASSWORD_9,
                .type = CONFIG_ITEM_TYPE_STRING,
                .secret = true,
                .def.str = ""
        },
        ...
        // ADMIN HOSTING MODE STATE
        {
                .key = KEY_CONFIG_MODE_ACTIVE,
                .type = CONFIG_ITEM_TYPE_UINT16,
                .def.uint16 = 0
        },{
...
static void config_restart_task(void *pvParameter) {
...
void config_restart() {
    ...
    xTaskCreate(config_restart_task, "config_restart_task", 4096, NULL, 5, NULL);
}
